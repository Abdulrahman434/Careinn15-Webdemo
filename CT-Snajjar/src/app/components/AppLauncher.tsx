          ...
          customRender: () => (
            <div className="relative flex items-center justify-center" style={{ width: 150, height: 150 }}>
              <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Background is handled by the app's bg property, but we can refine it here if needed */}
                {/* However, the app launcher renders the bg property on the tile itself. */}
                {/* I will draw the puzzle piece white and centered. */}
                <path 
    ...
    Tools: {
      ...
      apps: [
        ...
        },
        {
          ...
          name: locale === "ar" ? "التذكيرات والتقويم" : "Reminders & Calendar",
          bg: "linear-gradient(135deg, #0F6E56 0%, #1D9E75 100%)",
          mark: "",
          textColor: "#fff",
          customRender: () => (
            <div className="relative flex items-center justify-center" style={{ width: 150, height: 150 }}>
              <svg width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Bell – top-left area, centered around (26, 30) */}
                {/* Bell body */}
                <path
                  d="M26 42 C20 42 17 38 17 33 C17 25 21 19 26 17 C31 19 35 25 35 33 C35 38 32 42 26 42 Z"
                  fill="white"
                  opacity="0.95"
                />
                {/* Bell top stem */}
                <rect x="24.5" y="14" width="3" height="4" rx="1.5" fill="white" opacity="0.95" />
                {/* Bell clapper */}
                <ellipse cx="26" cy="43.5" rx="3.5" ry="2" fill="white" opacity="0.95" />
                {/* Bell bottom bar */}
                <rect x="18" y="41" width="16" height="2.5" rx="1.25" fill="white" opacity="0.95" />

                {/* Calendar – bottom-right area, centered around (60, 58) */}
                {/* Calendar outer rounded rect */}
                <rect x="46" y="44" width="30" height="28" rx="4" fill="white" opacity="0.95" />
                {/* Calendar header bar */}
                <rect x="46" y="44" width="30" height="8" rx="4" fill="white" />
                <rect x="46" y="48" width="30" height="4" fill="white" />
                {/* Header teal fill */}
                <rect x="47" y="45" width="28" height="6" rx="3" fill="#1D9E75" />
                {/* Binding pegs */}
                <rect x="52" y="42" width="3" height="5" rx="1.5" fill="white" opacity="0.95" />
                <rect x="69" y="42" width="3" height="5" rx="1.5" fill="white" opacity="0.95" />
                {/* Calendar grid dots – 3 cols × 2 rows */}
                <rect x="50" y="56" width="5" height="4" rx="1" fill="#1D9E75" opacity="0.7" />
                <rect x="59" y="56" width="5" height="4" rx="1" fill="#1D9E75" opacity="0.7" />
                <rect x="68" y="56" width="5" height="4" rx="1" fill="#1D9E75" opacity="0.7" />
                <rect x="50" y="63" width="5" height="4" rx="1" fill="#1D9E75" opacity="0.5" />
                <rect x="59" y="63" width="5" height="4" rx="1" fill="#1D9E75" opacity="0.5" />
                <rect x="68" y="63" width="5" height="4" rx="1" fill="#0F6E56" opacity="0.8" />

                {/* Subtle connecting arc between bell and calendar */}
                <path
                  d="M36 38 Q48 50 48 56"
                  stroke="white"
                  strokeWidth="1.5"
                  strokeDasharray="2 3"
                  strokeLinecap="round"
        ...
        {
          id: "todolist",
          name: locale === "ar" ? "قائمة المهام" : "To-Do List",
        ...
        {
          id: "watertracker",
          name: locale === "ar" ? "مراقب المياه" : "Water Intake",
        ...
        {
          id: "moodtracker",
          name: locale === "ar" ? "متتبع الحالة المزاجية" : "Mood Tracker",
        ...
        {
          id: "dailyquotes",
          name: locale === "ar" ? "اقتباسات يومية" : "Daily Quotes",
          bg: "linear-gradient(135deg, #10B981 0%, #059669 100%)",
          mark: "❝",
          textColor: "#fff",
          isInteractive: true,
