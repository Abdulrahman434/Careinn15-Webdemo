...
"ppf.yes": { en: "Yes", ar: "نعم", ur: "ہاں" },
  ...
  "care.dischargePlan.title": { en: "Discharge Plan", ar: "خطة الخروج", ur: "ڈسچارج پلان" },
  "care.discharge.title": { en: "Discharge Process", ar: "إجراءات الخروج", ur: "ڈسچارج پراسیس" },
  ...
  "care.discharge.financialClearance": { en: "Financial Closure & Clearance", ar: "إغلاق الحساب وإخلاء الطرف المالي", ur: "مالی حساب کی تکمیل اور کلیئرنس" },
