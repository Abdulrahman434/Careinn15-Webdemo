...
const translations: Record<string, TranslationEntry> = {
  ...
  "need.support.personal": { en: "Personal Care Assistance", ar: "المساعدة في العناية الشخصية", ur: "ذاتی نگہداشت میں معاونت" },
  "need.support.personal.sub": { en: "Help with bathing, grooming or dressing", ar: "مساعدة في الاستحمام أو العناية أو ارتداء الملابس", ur: "نہانے، گرومنگ یا کپڑے پہننے میں مدد" },
  "need.support.interpreter": { en: "Interpreter Request", ar: "طلب مترجم", ur: "مترجم کی درخواست" },
  "need.support.interpreter.sub": { en: "A translator to join your conversation with the care team", ar: "مترجم للانضمام إلى حديثك مع الفريق الطبي", ur: "کیئر ٹیم سے گفتگو کے لیے مترجم" },
