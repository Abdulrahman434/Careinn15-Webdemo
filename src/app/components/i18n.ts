...
const translations: Record<string, TranslationEntry> = {
  ...
  "general.language": { en: "Language", ar: "اللغة", ur: "زبان" },
  "general.lang.en": { en: "English", ar: "الإنجليزية", ur: "انگریزی" },
  "general.lang.ar": { en: "Arabic", ar: "العربية", ur: "عربی" },
  ...
  "need.tab.support": { en: "Support Services", ar: "خدمات الدعم", ur: "سپورٹ سروسز" },
  "need.title.support": { en: "How can we support you?", ar: "كيف يمكننا دعمك؟", ur: "ہم آپ کی کیسے مدد کر سکتے ہیں؟" },
  "need.sub.support": { en: "Personal care, language, faith and grooming services.", ar: "العناية الشخصية واللغة والدعم الديني وخدمات الحلاقة.", ur: "ذاتی نگہداشت، زبان، مذہبی معاونت اور گرومنگ خدمات۔" },
  "need.support.interpreter": { en: "Interpreter Request", ar: "طلب مترجم", ur: "مترجم کی درخواست" },
  "need.support.interpreter.sub": { en: "A spoken-language or sign-language interpreter to join your conversation with the care team", ar: "مترجم لغوي أو مترجم لغة إشارة للانضمام إلى حديثك مع الفريق الطبي", ur: "کیئر ٹیم سے گفتگو کے لیے بولی جانے والی زبان یا اشاروں کی زبان کا مترجم" },
  "need.support.interpreter.which": { en: "Which language do you need?", ar: "ما اللغة التي تحتاجها؟", ur: "آپ کو کون سی زبان درکار ہے؟" },
  "need.support.interpreter.summary": { en: "Language: {0}", ar: "اللغة: {0}", ur: "زبان: {0}" },
  "need.lang.arabic": { en: "Arabic", ar: "العربية", ur: "عربی" },
  "need.lang.english": { en: "English", ar: "الإنجليزية", ur: "انگریزی" },
  "need.lang.urdu": { en: "Urdu", ar: "الأردية", ur: "اردو" },
  "need.lang.hindi": { en: "Hindi", ar: "الهندية", ur: "ہندی" },
  "need.lang.tagalog": { en: "Filipino", ar: "الفلبينية", ur: "فلپائنو" },
  "need.lang.sign": { en: "Sign language", ar: "لغة الإشارة", ur: "اشاروں کی زبان" },
  "need.lang.other": { en: "Another language", ar: "لغة أخرى", ur: "کوئی اور زبان" },
  "need.lang.otherHint": { en: "Write the language you need in the box below.", ar: "اكتب اللغة التي تحتاجها في المربع أدناه.", ur: "مطلوبہ زبان نیچے دیے گئے خانے میں لکھیں۔" },
  "need.support.clergy": { en: "Religious & Spiritual Care", ar: "الرعاية الدينية والروحية", ur: "مذہبی و روحانی نگہداشت" },
  "need.support.clergy.sub": { en: "Consultation or visit by a Muslim Sheikh (Imam) for spiritual support and religious guidance", ar: "استشارة أو زيارة من شيخ مسلم (إمام) للدعم الروحي والإرشاد الديني", ur: "روحانی معاونت اور مذہبی رہنمائی کے لیے مسلم شیخ (امام) سے مشاورت یا ملاقات" },
  ...
  "need.item.nonslipsocks": { en: "Non-Slip Socks", ar: "جوارب مانعة للانزلاق", ur: "پھسلن سے محفوظ جرابیں" },
  ...
  "need.notes.placeholderRequest": { en: "Anything we should know? (optional)", ar: "هل من شيء يجب أن نعرفه؟ (اختياري)", ur: "کیا ہمیں کچھ جاننا چاہیے؟ (اختیاری)" },
  ...
  "news.dsfh.jeddah.6": { en: "DSFH Jeddah joins the Global Sepsis Alliance to help shape a new global hospital accreditation framework for sepsis care.", ar: "مستشفى الدكتور سليمان فقيه بجدة ينضم إلى التحالف العالمي للإنتان للمساهمة في تطوير إطار عالمي جديد لاعتماد المستشفيات في رعاية الإنتان (التسمم الدموي الجرثومي).", ur: "جدہ میں ڈاکٹر سلیمان فقیہ ہسپتال سیپسس کی دیکھ بھال کے لیے نئے عالمی ہسپتال ایکریڈیٹیشن فریم ورک کی تشکیل میں مدد کے لیے گلوبل سیپسس الائنس میں شامل ہو گیا۔" },
  ...
  "service.housekeeping": { en: "Patient Services", ar: "خدمات المرضى", ur: "مریض سروسز" },
...
"ppf.partner.details.title": { en: "Who will be your Care Partner?", ar: "من سيكون شريك الرعاية الخاص بك؟", ur: "آپ کا کیئر پارٹنر کون ہوگا؟" },
"ppf.partner.details.intro": { en: "A family member or friend who takes an active part in your care. Tell us who, so the team knows to include them.", ar: "أحد أفراد الأسرة أو صديق يشارك بفعالية في رعايتك. أخبرنا من هو ليتمكن الفريق من إشراكه.", ur: "خاندان کا فرد یا دوست جو آپ کی دیکھ بھال میں فعال حصہ لے۔ ہمیں بتائیں کہ وہ کون ہے تاکہ ٹیم انہیں شامل کر سکے۔" },
"ppf.partner.details.required": { en: "Both details are required to continue.", ar: "كلا الحقلين مطلوب للمتابعة.", ur: "جاری رکھنے کے لیے دونوں تفصیلات ضروری ہیں۔" },
...
"ppf.yes": { en: "Yes", ar: "نعم", ur: "ہاں" },
  ...
  "care.profile.details": { en: "Patient details", ar: "بيانات المريض", ur: "مریض کی تفصیلات" },
  "care.overview.details": { en: "Care details", ar: "تفاصيل الرعاية", ur: "نگہداشت کی تفصیلات" },
  "care.safety.title": { en: "Safety Alerts", ar: "تنبيهات السلامة", ur: "حفاظتی الرٹس" },
  "care.allergies.none": { en: "No known allergies", ar: "لا توجد حساسية معروفة", ur: "کوئی معلوم الرجی نہیں" },
  ...
  "care.tests.title": { en: "Tests and Procedures", ar: "الفحوصات والإجراءات", ur: "ٹیسٹ اور طریقہ کار" },
  "care.tests.procedures": { en: "Procedures", ar: "الإجراءات", ur: "طریقہ کار" },
  "care.tests.view": { en: "View", ar: "عرض", ur: "دیکھیں" },
  "care.tests.locked.title": { en: "Your Results Are Private", ar: "نتائجك خاصة", ur: "آپ کے نتائج نجی ہیں" },
  "care.questions.title": { en: "Questions for My Care Team", ar: "أسئلتي لفريق الرعاية", ur: "میری نگہداشت ٹیم کے لیے سوالات" },
  "care.questions.subtitle": { en: "Keep your questions here to discuss with your care team.", ar: "احتفظ بأسئلتك هنا لمناقشتها مع فريق الرعاية.", ur: "اپنے سوالات یہاں رکھیں تاکہ اپنی نگہداشت ٹیم سے بات کر سکیں۔" },
  "care.questions.empty": { en: "No questions yet", ar: "لا توجد أسئلة بعد", ur: "ابھی کوئی سوال نہیں" },
  "care.questions.emptyDesc": { en: "Add anything you would like to ask during your next care discussion.", ar: "أضف أي شيء تود سؤاله خلال لقائك القادم مع فريق الرعاية.", ur: "کوئی بھی بات شامل کریں جو آپ اپنی اگلی ملاقات میں پوچھنا چاہتے ہیں۔" },
  "care.questions.add": { en: "Add a question", ar: "إضافة سؤال", ur: "سوال شامل کریں" },
  "care.questions.edit": { en: "Edit question", ar: "تعديل السؤال", ur: "سوال میں ترمیم کریں" },
  "care.questions.placeholder": { en: "Type your question here", ar: "اكتب سؤالك هنا", ur: "اپنا سوال یہاں لکھیں" },
  "care.questions.save": { en: "Save", ar: "حفظ", ur: "محفوظ کریں" },
  "care.questions.delete": { en: "Delete", ar: "حذف", ur: "حذف کریں" },
  "care.observations.title": { en: "Vital Signs", ar: "العلامات الحيوية", ur: "حیاتی علامات" },
  ...
  "care.fallRisk.medium": { en: "Medium", ar: "متوسط", ur: "درمیانہ" },
  "care.fallRisk.low": { en: "Low", ar: "منخفض", ur: "کم" },
  "care.fallRisk.moderate": { en: "Moderate", ar: "متوسط", ur: "درمیانہ" },
  "care.fallRisk.none": { en: "No risk", ar: "لا يوجد خطر", ur: "کوئی خطرہ نہیں" },
  "care.alert.nameAlert": { en: "Name Alert", ar: "تنبيه تشابه الأسماء", ur: "نام الرٹ" },
  "care.alert.isolation": { en: "Isolation", ar: "عزل", ur: "آئسولیشن" },
  /* The precaution actually in force, shown on the badge in place of the bare
     word "Isolation" — which type it is, is the thing staff and visitors act on. */
  "care.isolation.type.contact": { en: "Contact", ar: "المخالطة", ur: "رابطہ" },
  "care.isolation.type.droplet": { en: "Droplet", ar: "الرذاذ", ur: "قطرے" },
  "care.isolation.type.airborne": { en: "Airborne", ar: "الهواء", ur: "ہوائی" },
  "care.isolation.type.protective": { en: "Protective", ar: "وقائي", ur: "حفاظتی" },
  "care.mobility.instructions": { en: "Mobility instructions", ar: "تعليمات الحركة", ur: "نقل و حرکت کی ہدایات" },
  ...
  /* ─── Discharge Plan ─── */
  "care.vitals.bp": { en: "Blood pressure", ar: "ضغط الدم", ur: "بلڈ پریشر" },
  "care.vitals.bpUnit": { en: "mmHg", ar: "ملم زئبق", ur: "ملی میٹر پارہ" },
  "care.vitals.hr": { en: "Heart rate", ar: "معدل ضربات القلب", ur: "دل کی دھڑکن" },
  "care.vitals.hrUnit": { en: "BPM", ar: "نبضة/دقيقة", ur: "دھڑکن/منٹ" },
  "care.vitals.temp": { en: "Temperature", ar: "درجة الحرارة", ur: "درجہ حرارت" },
  "care.vitals.spo2": { en: "Oxygen saturation", ar: "تشبع الأكسجين", ur: "آکسیجن سیچوریشن" },
  "care.vitals.pain": { en: "Pain score", ar: "درجة الألم", ur: "درد کا اسکور" },
  "care.observations.latest": { en: "Latest readings", ar: "أحدث القراءات", ur: "تازہ ترین ریڈنگز" },
  "care.observations.earlier": { en: "Earlier readings", ar: "القراءات السابقة", ur: "پچھلی ریڈنگز" },
  "care.observations.empty": { en: "No observations recorded", ar: "لا توجد ملاحظات مسجلة", ur: "کوئی مشاہدہ درج نہیں" },
  "care.vitals.resp": { en: "Respiratory rate", ar: "معدل التنفس", ur: "سانس کی رفتار" },
  "care.vitals.respUnit": { en: "/min", ar: "/دقيقة", ur: "/منٹ" },
  "care.isolation": { en: "Isolation precautions", ar: "إجراءات العزل", ur: "آئسولیشن احتیاطی تدابیر" },
  ...
  "care.labs.locked.noPin": { en: "Set a PIN so only you can open your results on this screen", ar: "قم بتعيين رمز سري حتى لا يتمكن أحد سواك من فتح نتائجك على هذه الشاشة", ur: "ایک پن مقرر کریں تاکہ صرف آپ ہی اس اسکرین پر اپنے نتائج کھول سکیں" },
  "care.labs.locked.unlock": { en: "Enter PIN", ar: "إدخال الرمز السري", ur: "پن درج کریں" },
  "care.labs.locked.setPin": { en: "Set a PIN", ar: "تعيين رمز سري", ur: "پن مقرر کریں" },
  "care.labs.pin.create": { en: "Choose a 4-digit PIN", ar: "اختر رمزًا سريًا من أربعة أرقام", ur: "4 ہندسوں کا پن منتخب کریں" },
  "care.labs.pin.confirm": { en: "Enter the PIN again", ar: "أدخل الرمز السري مرة أخرى", ur: "پن دوبارہ درج کریں" },
  "care.discharge.orderIssued": { en: "Discharge Order Issued", ar: "صدور أمر الخروج", ur: "ڈسچارج آرڈر جاری" },
  "care.discharge.medsOrdered": { en: "Medications Ordered", ar: "طلب الأدوية", ur: "ادویات کا آرڈر" },
  "care.discharge.medsDispensed": { en: "Medications Dispensed by Pharmacy", ar: "صرف الأدوية من الصيدلية", ur: "فارمیسی سے ادویات کی فراہمی" },
  "care.discharge.confirmed": { en: "Discharge Confirmed", ar: "تأكيد الخروج", ur: "ڈسچارج کی تصدیق" },
  "care.discharge.takeHomeMeds": { en: "Take-Home Medication", ar: "أدوية المنزل", ur: "گھر کے لیے ادویات" },
  "care.discharge.financialClearance": { en: "Financial Clearance", ar: "إخلاء الطرف المالي", ur: "مالی کلیئرنس" },
  "care.discharge.physicalDischarge": { en: "Physical Discharge", ar: "مغادرة المريض", ur: "مریض کی روانگی" },
  "care.discharge.cleaning": { en: "Room Cleaning", ar: "تنظيف الغرفة", ur: "کمرے کی صفائی" },
  "care.discharge.roomReady": { en: "Room Ready", ar: "الغرفة جاهزة", ur: "کمرہ تیار ہے" },
...
"care.pcc.status.notSet": { en: "Not set", ar: "غير محدد", ur: "مقرر نہیں" },
/* My Care Partner — the programme, the decision, the agreement, the result. */
...
"care.pcc.partner.namePlaceholder": { en: "e.g. Ahmed Saleh", ar: "مثال: أحمد صالح", ur: "مثلاً احمد صالح" },
"care.pcc.partner.relationship": { en: "Relationship to you", ar: "صلة القرابة بك", ur: "آپ سے رشتہ" },
"care.pcc.partner.relationshipPlaceholder": { en: "e.g. Son, Daughter, Spouse, Friend", ar: "مثال: ابن، ابنة، زوج/زوجة، صديق", ur: "مثلاً بیٹا، بیٹی، شریکِ حیات، دوست" },
"care.pcc.partner.handover": { en: "Please hand the screen to {0} to read and accept.", ar: "يرجى تسليم الشاشة إلى {0} للاطلاع والموافقة.", ur: "براہ کرم اسکرین {0} کو دیں تاکہ وہ پڑھ کر منظوری دیں۔" },
"care.pcc.partner.agreementTitle": { en: "Care Partner Agreement", ar: "اتفاقية شريك الرعاية", ur: "کیئر پارٹنر معاہدہ" },
"care.pcc.partner.agreementIntro": { en: "As a care partner, I agree to:", ar: "بصفتي شريك رعاية، أوافق على:", ur: "بطور کیئر پارٹنر، میں اتفاق کرتا/کرتی ہوں کہ:" },
"care.pcc.partner.commit.rounds": { en: "Take part in rounds and care discussions when I can", ar: "المشاركة في الجولات ومناقشات الرعاية عند الإمكان", ur: "جب ممکن ہو راؤنڈز اور نگہداشت کی گفتگو میں شریک ہوں" },
"care.pcc.partner.commit.learn": { en: "Learn the care tasks I will help with after discharge", ar: "تعلّم مهام الرعاية التي سأساعد بها بعد الخروج", ur: "ڈسچارج کے بعد جن کاموں میں مدد کروں گا/گی وہ سیکھوں" },
"care.pcc.partner.commit.speakUp": { en: "Speak up to the care team if something does not seem right", ar: "إبلاغ فريق الرعاية إذا لاحظت أمرًا غير صحيح", ur: "کچھ ٹھیک نہ لگے تو نگہداشت ٹیم کو بتاؤں" },
...
/* ─── Care Partner Agreement ───
   ...
   is a document the care partner signs, so the wording is theirs, not ours —
   do not paraphrase it. The Urdu is a translation and is marked as such for
   review. */
"care.cp.title": { en: "Care Partner Agreement Checklist", ar: "نموذج اتفاقية (مرافق المريض) شريك الرعاية", ur: "کیئر پارٹنر معاہدہ چیک لسٹ" },
"care.cp.intro": { en: "The Care Partner shall:", ar: "كشريك في الرعاية أثناء فترة وجودي مع المريض في المستشفى يجب علي معرفة الآتي:", ur: "کیئر پارٹنر کی حیثیت سے مریض کے ساتھ ہسپتال میں اپنے قیام کے دوران مجھے درج ذیل باتیں معلوم ہونی چاہیے:" },
"care.cp.item.1": { en: "Receive a reasonable explanation and education regarding Fakeeh Care rules, regulations, basic infection control measures, patient's medical condition, prevention of fall etc.", ar: "أن أحصل على شرح وافي وتعليم بخصوص قواعد مجموعة فقيه الطبية، اللوائح، الإجراءات الأساسية لمكافحة العدوى والسلامة، حالة المريض الصحية، الوقاية من السقوط، إلخ.", ur: "فقیہ کیئر کے قواعد، ضوابط، انفیکشن کنٹرول کے بنیادی اقدامات، مریض کی طبی حالت اور گرنے سے بچاؤ وغیرہ کے بارے میں مناسب وضاحت اور تربیت حاصل کروں۔" },
"care.cp.item.2": { en: "Be oriented to surroundings, call light such as: the bell of the nursing call, and routines to expect in plan of care.", ar: "أن أكون على علم بالبيئة المحيطة حولي، مثل: الجرس الخاص بنداء التمريض، والروتين المتوقع في برنامج الرعاية للمريض.", ur: "اپنے اردگرد کے ماحول سے واقف ہوں، مثلاً نرسنگ کال کی گھنٹی، اور نگہداشت کے منصوبے میں متوقع معمولات۔" },
"care.cp.item.3": { en: "Be provided with furniture arrangement for adequate rest/sleep, such as: blanket and bed linen.", ar: "أن يتم تزويدي بالأثاث اللازم للراحة والنوم، مثل: البطانية وأغطية السرير.", ur: "مناسب آرام اور نیند کے لیے ضروری سامان فراہم کیا جائے، مثلاً کمبل اور بستر کی چادریں۔" },
"care.cp.item.4": { en: "Be provided with required support services as needed (i.e. clergy support, social worker, interpreter etc).", ar: "أن أحصل على الدعم المطلوب حسب احتياجاتي (الدينية والروحية، أو الاخصائي الإجتماعي، أو المترجم الخ).", ur: "ضرورت کے مطابق مطلوبہ معاون خدمات فراہم کی جائیں (مثلاً مذہبی و روحانی رہنمائی، سماجی کارکن، یا مترجم وغیرہ)۔" },
"care.cp.item.5": { en: "Be informed that the care partner has the right to express their concerns, suggestions, compliment etc and to receive feedback.", ar: "أن أكون على علم بأن لي الحق في التعبير عن مخاوفي واقتراحاتي وملاحظاتي.", ur: "مجھے علم ہو کہ کیئر پارٹنر کو اپنے تحفظات، تجاویز اور تعریفی رائے دینے اور جواب پانے کا حق ہے۔" },
"care.cp.item.6": { en: "Stay with their patient all the time, maintain confidentiality of patient information and assist him in selecting meals also help him with eating, walking, movement, bathing and personal care.", ar: "يجب علي البقاء مع المريض طوال الوقت والمحافظة على سرية معلومات المريض ومساعدته في اختيار وجبات الطعام وأيضا مساعدته في الأكل والمشي والحركة والاستحمام والرعاية الشخصية.", ur: "ہر وقت اپنے مریض کے ساتھ رہوں، مریض کی معلومات کی رازداری قائم رکھوں، کھانے کے انتخاب میں مدد کروں اور کھانے، چلنے، حرکت، نہانے اور ذاتی نگہداشت میں معاونت کروں۔" },
"care.cp.item.7": { en: "Provide accurate information about his/her medical condition, medications and other matters relating to their health history if any.", ar: "يجب الإفصاح عن حالتي الطبية والعلاجات التي استخدمها إن وجدت.", ur: "اپنی طبی حالت، ادویات اور صحت کی تاریخ سے متعلق دیگر امور کے بارے میں درست معلومات فراہم کروں، اگر کوئی ہوں۔" },
"care.cp.item.8": { en: "Preserve and take care of any hospital property and equipment in patient care area and not to handle any medical equipment.", ar: "الحفاظ على ممتلكات ومعدات المستشفى في منطقة رعاية المرضى والعناية بها وعدم العبث بالمعدات الطبية.", ur: "مریضوں کی نگہداشت کے علاقے میں ہسپتال کی ملکیت اور سازوسامان کی حفاظت کروں اور کسی طبی سازوسامان کو نہ چھیڑوں۔" },
"care.cp.item.9": { en: "Notify the nursing team upon changing the care partner.", ar: "إخطار فريق التمريض عند تغيير شريك الرعاية.", ur: "کیئر پارٹنر کی تبدیلی پر نرسنگ ٹیم کو مطلع کروں۔" },
"care.cp.item.10": { en: "Be educated regarding taking pictures, video clips and voice recording are totally prohibited by KSA regulations and any breach to that puts the caregiver liable for the hospital policy through official government channels.", ar: "يجب أن أكون على دراية بأن التقاط الصور و مقاطع الفيديو والتسجيل الصوتي في المستشفى للعاملين و الزوار محظور تماماً بموجب لوائح المملكة العربية السعودية.", ur: "مجھے علم ہو کہ سعودی عرب کے ضوابط کے تحت تصاویر، ویڈیو اور آواز کی ریکارڈنگ مکمل طور پر ممنوع ہے، اور اس کی خلاف ورزی پر نگہداشت کرنے والا سرکاری ذرائع کے ذریعے ہسپتال کی پالیسی کے تحت جوابدہ ہوگا۔" },
"care.cp.item.11": { en: "Not keep valuables, jewelry and other personal belongings or cash in the room and be informed that the hospital will not be held accountable for the loss.", ar: "عدم الاحتفاظ بالأشياء الثمينة والمجوهرات والأغراض الشخصية الأخرى أو الأموال النقدية في الغرفة و المستشفى غير مسؤولة في حالة فقدانها.", ur: "قیمتی اشیاء، زیورات، دیگر ذاتی سامان یا نقد رقم کمرے میں نہ رکھوں، اور مجھے علم ہو کہ گم ہونے کی صورت میں ہسپتال ذمہ دار نہیں ہوگا۔" },
"care.cp.item.12": { en: "A nurse/doctor may ask the care partner to leave the room at any time where a certain intervention / procedure is performed for the care of their loved ones or other patients.", ar: "أن أكون على علم أنه من الممكن أن يطلب الطبيب أو الممرضة من شريك الرعاية مغادرة الغرفة في أي وقت يتم فيه إجراء معين/ إجراء خاص لرعاية أحبائهم أو مرضى آخرين.", ur: "نرس یا ڈاکٹر کسی بھی وقت کیئر پارٹنر سے کمرہ چھوڑنے کو کہہ سکتے ہیں جب ان کے عزیز یا دیگر مریضوں کی نگہداشت کے لیے کوئی خاص طریقۂ علاج کیا جا رہا ہو۔" },
"care.cp.item.13": { en: "It is my right to know the most important skills and information that help me take care of a patient at home.", ar: "إن من حقي معرفة أهم المهارات والمعلومات التي تساعدني في رعاية المريض بالمنزل.", ur: "یہ میرا حق ہے کہ مجھے وہ اہم مہارتیں اور معلومات بتائی جائیں جو گھر پر مریض کی دیکھ بھال میں میری مدد کریں۔" },
"care.cp.item.14": { en: "When possible, obtain verbal consent from the patient to authorize a family member / care giver to be a care partner.", ar: "احصل على موافقة شفهية من المريض (اذا كان ممكنا) لتفويض فرد من الأسرة ليكون شريكًا في الرعاية.", ur: "جب ممکن ہو، مریض سے زبانی رضامندی حاصل کروں تاکہ خاندان کے کسی فرد یا نگہداشت کرنے والے کو کیئر پارٹنر بنایا جا سکے۔" },
"care.cp.ack": { en: "I acknowledge that I have read, understood and agreed to all the above mentioned statements, and I have signed this agreement expressing my full acceptance.", ar: "أقر بأنني قرأت وفهمت ووافقت على جميع البيانات المذكورة أعلاه، وقد وقعت على هذه الاتفاقية معبراً عن قبولي الكامل.", ur: "میں اقرار کرتا/کرتی ہوں کہ میں نے مذکورہ بالا تمام بیانات پڑھے، سمجھے اور ان سے اتفاق کیا، اور اپنی مکمل رضامندی کے اظہار کے طور پر اس معاہدے پر دستخط کیے ہیں۔" },
"care.cp.field.name": { en: "Name of the Care Partner", ar: "اسم شريك الرعاية", ur: "کیئر پارٹنر کا نام" },
"care.cp.field.relationship": { en: "Relation to Patient", ar: "صلة القرابة", ur: "مریض سے رشتہ" },
...
"care.preferences.edit": { en: "Edit my preferences", ar: "تعديل تفضيلاتي", ur: "میری ترجیحات میں ترمیم کریں" },
...
"ppf.q.handover.presence": { en: "Would you prefer to be present with your care partner during bedside handover at 7:00 AM and 7:00 PM, even if this means being awakened at the scheduled time?", ar: "هل تفضل أن تكون حاضرًا مع شريك الرعاية أثناء تسليم المناوبة بجانب السرير عند الساعة السابعة صباحًا والسابعة مساءً، حتى لو تطلّب ذلك إيقاظك في الوقت المحدد؟", ur: "کیا آپ صبح 7:00 اور شام 7:00 بجے بیڈ سائیڈ ہینڈ اوور کے دوران اپنے کیئر پارٹنر کے ساتھ موجود رہنا پسند کریں گے، چاہے اس کے لیے آپ کو مقررہ وقت پر جگانا پڑے؟" },
/* This question's answers are a choice between two arrangements, not a bare
   yes and no, so it carries its own wording for each. Questions with no
   ppf.answer.* entry fall back to the plain Yes / No. */
"ppf.answer.handover.presence.yes": { en: "Yes — Wake me so I can participate with my care partner.", ar: "نعم، أفضّل أن أكون حاضرًا مع شريك الرعاية، حتى لو احتاج الأمر إلى إيقاظي.", ur: "جی ہاں — مجھے جگا دیں تاکہ میں اپنے کیئر پارٹنر کے ساتھ شریک ہو سکوں۔" },
"ppf.answer.handover.presence.no": { en: "No — Please do not wake me; I prefer to receive a summary later.", ar: "لا، أفضل عدم إيقاظي، ويمكنني استلام ملخص عن تسليم المناوبة لاحقًا.", ur: "نہیں — براہ کرم مجھے نہ جگائیں؛ میں بعد میں خلاصہ وصول کرنا پسند کروں گا۔" },
...
"ppf.q.comfort.grooming": { en: "Would you like barber or salon services?", ar: "هل ترغب بخدمات الحلاقة أو الصالون؟", ur: "کیا آپ باربر یا سیلون کی خدمات چاہیں گے؟" },
...
"ppf.short.food.mealTiming": { en: "Change Meal Times", ar: "تغيير أوقات الوجبات", ur: "کھانے کے اوقات تبدیل کریں" },
...
"ppf.short.partner.name": { en: "Care Partner", ar: "شريك الرعاية", ur: "کیئر پارٹنر" },
"ppf.short.partner.relationship": { en: "Relationship", ar: "صلة القرابة", ur: "رشتہ" },
...
"ppf.short.comfort.grooming": { en: "Barber / Salon services", ar: "خدمات الحلاقة والصالون", ur: "باربر / سیلون خدمات" },
...
"ppf.note.comfort.grooming": { en: "Tell us which services you need", ar: "أخبرنا بالخدمات التي تحتاجها", ur: "ہمیں بتائیں کہ آپ کو کون سی خدمات درکار ہیں" },
